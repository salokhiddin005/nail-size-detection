  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(236,72,153,0.10),transparent_30%),radial-gradient(circle_at_top_right,rgba(139,92,246,0.08),transparent_26%)]" />

        <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 py-16">
          <div className="max-w-4xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/30 px-4 py-2 text-xs uppercase tracking-[0.28em] text-white/70 backdrop-blur">
            ...
            <div className="mt-12 max-w-3xl rounded-3xl border border-white/10 bg-black/35 p-4 backdrop-blur-xl md:p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-3">
                ...
                <Link
                  href="/how-it-works"
                  className="group rounded-2xl border border-dashed border-white/10 bg-black/25 px-4 py-4 transition hover:border-white/20 hover:bg-white/[0.04]"
                >
                  <div>
